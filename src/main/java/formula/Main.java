...
public class Main implements IGlobalErrorHandler {
  ...
  //static EntityManagerFactory femf = Persistence.createEntityManagerFactory("formulaPU");
  //static EntityManagerFactory hemf = Persistence.createEntityManagerFactory("holbeinmPU");
  /**
